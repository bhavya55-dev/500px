                    ...
                    if (isset($_POST['changepersonal']))
                        {
                            ...
                            $dob = $_POST["dob"];   
                                ...
                                $sql ="UPDATE $loggedonuser SET firstname = '$firstname', lastname = '$lastname'";
            ...
            <form class="form" method="post">
                <FIELDSET>
                    <legend align="center"><h3>PERSONAL INFORMATION</h3></legend>
                        <center>
                            <input class="txt" type="text" name="firstname" placeholder="FIRST NAME" pattern="[^0-9][a-zA-Z]+"><br><br>

                            <input class="txt" type="text" name="lastname" placeholder="LAST NAME" pattern="[^0-9][a-zA-Z]+"><br><br>
